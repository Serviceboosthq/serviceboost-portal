...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 bg-gradient-to-br from-[#0f172a] via-[#0b1e3a] to-[#0a1628] min-h-screen text-white p-10">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-4">
          ...
          <div className="bg-slate-800/60 backdrop-blur-md rounded-xl p-6 w-56 shadow-lg">
            <p className="text-slate-400 text-sm">Company</p>
            <p className="text-lg font-semibold mt-1">Demo Pest Control</p>
          </div>
      ...
      <div className="grid grid-cols-4 gap-6 mt-10">
        ...
        <div className="bg-slate-800/60 backdrop-blur-md rounded-xl p-6 shadow-lg">
      ...
      <div className="bg-slate-800/60 backdrop-blur-md rounded-xl p-8 mt-12 shadow-lg">
